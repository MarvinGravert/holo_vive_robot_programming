...
public class SendRegistration : MonoBehaviour
{
    public string sendPointPairsEventName;
    ...
    void OnEnable()
    {
        ...
        EventManager.StartListening(sendPointPairsEventName, SendToServer);

    }
    void OnDisable()
    {

        EventManager.StopListening(sendPointPairsEventName, SendToServer);
    }
}
